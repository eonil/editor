...
class RustSourceCodeDocument : NSDocument {
	...
	override func dataOfType(typeName: String, error outError: NSErrorPointer) -> NSData? {
		let	s1	=	projectWindowController.mainViewController.codeEditingViewController.textViewController.textView.string!
	...
	override func readFromData(data: NSData, ofType typeName: String, error outError: NSErrorPointer) -> Bool {
		...
		projectWindowController.mainViewController.codeEditingViewController.textViewController.textView.string	=	s1
...
//			let	s1	=	mainEditorWindowController.splitter.codeEditingViewController.textViewController.textView.string!
			...
			projectWindowController.mainViewController.commandConsoleViewController.textViewController.textView.string	=	r1
