...
//import AppKit
//
//class FileTreeViewController3 : NSViewController, NSOutlineViewDataSource, NSOutlineViewDelegate {
//	
//	let	userIsWantingToEditFileAtPath	=	Notifier<String>()
//	
//	private	var	_fileTreeRepository		=	FileTreeRepository3()
...
//	}
//	private func onAddingNodes(ns:[FileNode3]) {
...
//	}
//	private func onRemovingNodes(ns:[FileNode3]) {
////		let	ns2	=	ns.map({$0.supernode}).filter({$0 != nil}).map({$0!})
////		let	ns3	=	deduplicate(ns2)
////		
////		self.outlineView.beginUpdates()
...
//			_fileTreeRepository.rootLocationURL	=	nil
//		}
//		didSet {
//			if let v3 = URLRepresentation {
//				_fileTreeRepository.rootLocationURL	=	v3
//			}
...
//		
//		_channelsHolding	=	[
//			channel(_fileTreeRepository.notifyError, onError),
//			channel(_fileTreeRepository.notifyAddingNodes, onAddingNodes),
//			channel(_fileTreeRepository.notifyRemovingNodes, onRemovingNodes),
//		]
//	}
//	
//	
...
//		let	n1	=	item as FileNode3?
//		if let n2 = n1 {
//			return	n2.subnodes.count
//		} else {
//			return	_fileTreeRepository.rootNode == nil ? 0 : 1
//		}
//	}
...
//		} else {
//			return	_fileTreeRepository.rootNode!
//		}
//	}
...
//		let	n1	=	item as FileNode3
//		assert(n1.existing)
//		iv1.image						=	NSWorkspace.sharedWorkspace().iconForFile(n1.absoluteURL.path!)
...
////		let	n1		=	self.outlineView.itemAtRow(idx1) as FileNode3
