...
class WorkspaceMenuReconfigurator {
	...
	init(workspace: Workspace) {
		...
		workspace.tools.cargo.availableCommands.emitter.register(_cargoCommandWatch)
	...
	deinit {
		...
		workspace.tools.cargo.availableCommands.emitter.deregister(_cargoCommandWatch)
	}
