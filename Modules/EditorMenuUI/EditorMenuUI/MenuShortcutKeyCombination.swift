...
struct MenuShortcutKeyCombination {
	...
	var modifierMask: Int {
		get {
			return	(commandModifier ? Int(bitPattern: NSEventModifierFlags.CommandKeyMask.rawValue) : 0)
...
let None		=	MenuShortcutKeyCombination(plainTextKeys: "", commandModifier: false, alternateModifier: false, shiftModifier: false)
