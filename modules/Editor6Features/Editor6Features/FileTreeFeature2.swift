...
public final class FileTreeFeature2 {
...
public extension FileTreeFeature2 {
    public struct Issue {
...
public extension FileTreeFeature2.Path {
    ...
    public init(relativeFileURLFromWorkspaceRoot u: URL) throws {
        ...
        self = FileTreeFeature2.Path(components: u.pathComponents)
    }
