...
class Bitree1UnitTests: XCTestCase {

    func testInit1() {
        let t = Bitree1<Int, String>(state: "AAA")
        XCTAssertEqual(t.root.state, "AAA")
    }
    func testInit2() {
        let id = 111
        let s = "AAA"
        let t = Bitree1<Int, String>(root: (id, s))
    ...
    func testInsert1() {
        let id = 111
        let s = "AAA"
        var t = Bitree1<Int, String>(root: (id, s))
        let id2 = 222
        let s2 = "BBB"
        ...
        XCTAssertEqual(t.parent(of: 222), 111)
        XCTAssertEqual(t.parent(of: 111), nil)
    }

}

extension Int: Bitree1NodeKey {
}
