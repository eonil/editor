...
//    }
    ...
    typealias Delegate = (_ sender: Bash1, _ action: Action) -> ()

    private let subproc = Subprocess1Controller(path: "/bin/bash", arguments: ["--login", "-s"])
    private let ioqp: IOQueuePair
