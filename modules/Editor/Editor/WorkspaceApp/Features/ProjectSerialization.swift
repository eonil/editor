...
////    private static let magic = "Editor Workspace Format 0.0.0/0"
////    static func encode(_ p: Package) -> String {
////        var lines = [String]()
////        lines.append(magic)
////        let fs = p.files.sortedTopologically()
////        for (p, c) in fs {
...
////        return lines.map({ $0 + "\n" }).joined()
////    }
////    static func decode(_ s: String) -> Result<Package, String> {
...
////            pkg.files.append(p, c)
////        }
////        return .success(pkg)
////    }
////}
////extension ProjectSerialization {
////    struct Package {
...
////}
//
//extension ProjectFeature.NodeKind {
//    init?(code: String) {
//        switch code {
//        case "g":
//            self = .folder
