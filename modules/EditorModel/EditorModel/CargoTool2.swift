...
//	enum Event {
//		case DidChangeState
//		case DidEmitOutputLogLine(String)
//		case DidEmitErrorLogLine(String)
//		case DidComplete
//	}
//
//
...
//		// Extra stdout/stderr output can come up even after
//		// task termination. So we need to wait for them until
...
//
//		_deinstallObservers()
//		assert(onEvent != nil, "Expects `onEvent` already be set by programmer.")
//		onEvent?(.DidComplete)
//	}
...
//		assert(onEvent != nil, "Expects `onEvent` already be set by programmer.")
//		onEvent?(.DidEmitOutputLogLine(line))
//	}
//
...
//		Debug.assertMainThread()
//		assert(onEvent != nil, "Expects `onEvent` already be set by programmer.")
//		onEvent?(.DidEmitErrorLogLine(line))
//	}
//
//
//
