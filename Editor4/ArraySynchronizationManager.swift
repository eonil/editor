...
//    ///
//    /// - Returns:
//    ///     Indexes of changed elements.
//    ///
//    mutating func syncFrom<A: IndexJournalingArrayType where A.Generator.Element == Element.SourceType, A.Index == Int>(sourceArray: A) -> [Int] {
...
//    /// - Parameters:
//    ///     First paramter is index of changed elements.
//    case OK([Int])
//    case CancelBecauseJournalUnavailableForCurrentVersion
//}
//
