...
//                return driver.userInteraction.dispatch { state in
...
//                    return workspaceID
//                }.continueOnSuccessWith { workspaceID in
//                    return driver.run(PlatformCommand.RestoreWorkspace(workspaceID, location: u))
//                }
//            }
//
//        case .FileCloseWorkspace:
//            guard let workspaceID = state.currentWorkspaceID else { throw UserOperationError.MissingCurrentWorkspace }
//            driver.userCommandExecution.dispatch(.closeWorkspace(workspaceID))
//            return driver.userInteraction.dispatch { state in
